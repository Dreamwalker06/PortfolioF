...
Je suis agréablement surpris de découvrir cette nouvelle passion qui me pousse chaque jour à me surpasser. Je m'investis pleinement dans l'apprentissage du développement web, cherchant constamment à m'améliorer et à repousser mes limites."> */
          ...
          <br></br>Après avoir consacré 5 ans à ce jeu, j'ai décidé de me lancer dans une carrière individuelle en explorant différents domaines tels que le streaming, la pédagogie, l'animation, et bien d'autres encore. <br></br>Cependant, j'ai récemment entrepris un nouveau défi qui m'a profondément passionné : <span>le développement web</span>.
